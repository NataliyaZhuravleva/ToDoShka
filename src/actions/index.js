...
export const makeApiCall = (category) => {
  return dispatch => {
    ...
    return fetch(`https://api.opentripmap.com/0.1/en/places/radius?radius=1000&lon=-115.13722&lat=36.17497&kinds=${category}&&format=json&apikey=${process.env.REACT_APP_API_KEY}`)
